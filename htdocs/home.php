                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <?php
                                $where = "";
                                if ($cid != 'all' && is_numeric($cid)) {
                                    $where  = " AND category_id = $cid ";
                                }

                                // Fix the SQL query for products
                                $sql = "SELECT * FROM products WHERE unix_timestamp(bid_end_datetime) >= " . strtotime(date("Y-m-d H:i")) . " $where ORDER BY name ASC";
                                    ...
                                    <div class="card">
                                        <div class="float-right align-top bid-tag">
                                            <span class="badge badge-pill badge-primary text-white">
                                                <i class="fa fa-tag"></i> <?php echo number_format($row['start_bid']) ?>
                                            </span>
                                        </div>
                                        ...
                                        <div class="float-right align-top d-flex">
                                            <span class="badge badge-pill badge-warning text-white">
                                                <i class="fa fa-hourglass-half"></i> <?php echo date("M d, Y h:i A", strtotime($row['bid_end_datetime'])) ?>
                                            </span>
                                        </div>
